...
USAGE+=" (-w=|--scripts=)<wiced scripts path>"
...
"$CY_TOOL_intel_hex_merge_EXE_ABS" "$CY_APP_HEX.ds1" "$CY_DS2_APP_HEX" "$CY_APP_HEX"
"$CY_TOOL_intel_hex_to_hcd_EXE_ABS" "$CY_APP_HEX" "$CY_APP_HCD"
fi
...
"$CY_TOOL_intel_hex_merge_EXE_ABS" "$CY_APP_HEX.temp" "$CY_APP_HEX_STATIC" "$CY_APP_HEX"
"$CY_TOOL_intel_hex_to_hcd_EXE_ABS" "$CY_APP_HEX" "$CY_APP_HCD"
fi
...
echo "$CY_TOOL_cgs_EXE_ABS -D $CY_MAINAPP_BUILD_DIR -B $CY_APP_BTP $CY_APP_CGS_ARGS -O DLConfigVSLocation:0x2000 -O DLConfigFixedHeader:0 -O DLMaxWriteSize:251 -I $CY_APP_HEX_SS --cgs-files $CY_APP_FAILSAFE"
"$CY_TOOL_cgs_EXE_ABS" -D "$CY_MAINAPP_BUILD_DIR" -B "$CY_APP_BTP" $CY_APP_CGS_ARGS -O DLConfigVSLocation:0x2000 -O DLConfigFixedHeader:0 -O DLMaxWriteSize:251 -I "$CY_APP_HEX_SS" --cgs-files "$CY_APP_FAILSAFE"
...
"$CY_TOOL_intel_hex_to_bin_EXE_ABS" -a "$CY_APP_HEX_SS" "$CY_APP_HEX_SS.full.txt"
...
"$CY_TOOL_head_or_tail_EXE_ABS" H -3 "$CY_APP_HEX_SS.full.txt" "$CY_APP_HEX_SS.txt"
...
$CY_TOOL_cgs_EXE_ABS -D "$CY_MAINAPP_BUILD_DIR" $CY_APP_CGS_ARGS -B "$CY_APP_BTP" -I "$CY_APP_HEX.ihexserial.temp.hex" --cgs-files "$CY_MAINAPP_BUILD_DIR/$CY_MAINAPP_NAME.cgs"
...
"$CY_TOOL_append_to_intel_hex_EXE_ABS" -I 0x1b "$CY_APP_HEX_SS.txt" "$CY_APP_HEX.ihexserial.temp.hex" "$CY_APP_HEX.combined.hex"
...
"$CY_TOOL_shift_intel_hex_EXE_ABS" 0xFF000000 "$CY_APP_HEX.combined.hex" "$CY_APP_HEX"
...
"$CY_TOOL_intel_hex_to_bin_EXE_ABS" -l $DS_ADDR -f 00 "$CY_APP_HEX" "$CY_APP_OTA_BIN"
# print size
