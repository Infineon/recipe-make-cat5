...
if [ ${VERBOSE} -ne 0 ]; then
    ...
    echo 27: CY_APP_SUBDS_START   : $CY_APP_SUBDS_START
    echo 28: CY_APP_LD_GEN        : $CY_APP_LD_GEN
    echo 29: CY_APP_LD_PATH       : $CY_APP_LD_PATH
    echo 30: CY_APP_LD_DEFS       : $CY_APP_LD_DEFS
    echo 31: CY_TOOL_cgs_EXE_ABS   : $CY_TOOL_cgs_EXE_ABS
    echo 32: CY_TOOL_det_and_id_EXE_ABS : $CY_TOOL_det_and_id_EXE_ABS
    echo 33: CY_TOOL_append_to_intel_hex_EXE_ABS : $CY_TOOL_append_to_intel_hex_EXE_ABS
    echo 34: CY_TOOL_head_or_tail_EXE_ABS : $CY_TOOL_head_or_tail_EXE_ABS
    echo 35: CY_TOOL_intel_hex_merge_EXE_ABS : $CY_TOOL_intel_hex_merge_EXE_ABS
    echo 36: CY_TOOL_intel_hex_to_bin_EXE_ABS : $CY_TOOL_intel_hex_to_bin_EXE_ABS
    echo 37: CY_TOOL_intel_hex_to_hcd_EXE_ABS : $CY_TOOL_intel_hex_to_hcd_EXE_ABS
    echo 38: CY_TOOL_shift_intel_hex_EXE_ABS : $CY_TOOL_shift_intel_hex_EXE_ABS
fi
...
if [[ ${CY_APP_MERGE_HEX_NAME} = *"hex"* ]]; then
    ...
    # Merge all hex files
    MERGE_HEX_COMMAND="${CY_TOOL_intel_hex_merge_EXE_ABS} -L 240 ${CY_DS_SUB_MDH_HEX} ${CY_APP_HEX_CERT} ${CY_APP_HEX} ${CY_APP_HEX}"
    if [ ${VERBOSE} -ne 0 ]; then
